...
<head>
	...
	<link rel="shortcut icon" href="<?= base_url('/src/mazer/') ?>/assets/compiled/svg/favicon.svg" type="image/x-icon">
	...
	<link rel="stylesheet" href="<?= base_url('/src/mazer/') ?>/assets/compiled/css/app.css">
	<link rel="stylesheet" href="<?= base_url('/src/mazer/') ?>/assets/compiled/css/app-dark.css">
	<link rel="stylesheet" href="<?= base_url('/src/mazer/') ?>/assets/compiled/css/iconly.css">
...
<body>
	<div id="app">
			...
			<div class="sidebar-wrapper active">
				<div class="sidebar-header position-relative">
					<div class="d-flex justify-content-between align-items-center">
						<div class="logo">
							<a href="index.html"><img src="<?= base_url('/src/mazer/') ?>/assets/compiled/svg/logo.svg" alt="Logo" srcset=""></a>
						</div>
						<div class="theme-toggle d-flex gap-2  align-items-center mt-2">
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
								...
								<g fill="none" fill-rule="evenodd" stroke="currentColor" stroke-linecap="round"
									...
									<path
										d="M10.5 14.5c2.219 0 4-1.763 4-3.982a4.003 4.003 0 0 0-4-4.018c-2.219 0-4 1.781-4 4c0 2.219 1.781 4 4 4zM4.136 4.136L5.55 5.55m9.9 9.9l1.414 1.414M1.5 10.5h2m14 0h2M4.135 16.863L5.55 15.45m9.899-9.9l1.414-1.415M10.5 19.5v-2m0-14v-2"opacity=".3"></path>
		...
		<div id="main">
			...
			<footer>
				<div class="footer clearfix mb-0 text-muted" style="bottom: 0; position: absolute; width: 75%;">
	...
	<script src="<?= base_url('/src/mazer/') ?>assets/static/js/components/dark.js"></script>
	<script src="<?= base_url('/src/mazer/') ?>assets/extensions/perfect-scrollbar/perfect-scrollbar.min.js"></script>
	<script src="<?= base_url('/src/mazer/') ?>assets/compiled/js/app.js"></script>
	<!-- Need: Apexcharts -->
	<script src="<?= base_url('/src/mazer/') ?>assets/extensions/apexcharts/apexcharts.min.js"></script>
	<script src="<?= base_url('/src/mazer/') ?>assets/static/js/pages/dashboard.js"></script>
</body>
